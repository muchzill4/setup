---
description: Review this conversation and update ~/.claude/CLAUDE.md, principles, and skill files with learned preferences
...
- **Always-loaded principles** (programming, source-control, etc.) → the matching file under `~/.claude/principles/`
...
2. List all existing principle files with `Glob` for `~/.claude/principles/*.md` and skill files with `Glob` for `~/.claude/skills/*/SKILL.md`
3. Read any principle or skill files that may be relevant to the conversation
